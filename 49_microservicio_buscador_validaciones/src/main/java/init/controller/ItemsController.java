...
public class ItemsController {
	...
	public ResponseEntity<List<ItemDto>> buscarItems(@Parameter(description="Nombre de la temática de búsqueda")@Size(min=3)@PathVariable("tematica") String tematica) {
